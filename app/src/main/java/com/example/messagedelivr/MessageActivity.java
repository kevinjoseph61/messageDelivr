...
import com.example.messagedelivr.Adapter.MessageAdapter;
import com.example.messagedelivr.Fragments.APIService;
import com.example.messagedelivr.Model.Chat;
import com.example.messagedelivr.Model.User;
import com.example.messagedelivr.Notifications.Client;
import com.example.messagedelivr.Notifications.Data;
import com.example.messagedelivr.Notifications.MyResponse;
import com.example.messagedelivr.Notifications.Sender;
import com.example.messagedelivr.Notifications.Token;
                            ...
                            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                if (response.code() == 200){
                                    if (response.body().success != 1){
                                        Log.d("Push notif API","Push notification error");
                                    }
                                }
                            }
