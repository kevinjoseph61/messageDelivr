...
import com.example.messagedelivr.Adapter.OnItemClick;
import com.example.messagedelivr.Fragments.ChatsFragment;
import com.example.messagedelivr.Fragments.ProfileFragment;
import com.example.messagedelivr.Fragments.UsersFragment;
import com.example.messagedelivr.Model.Chat;
import com.example.messagedelivr.Model.User;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (unread == 0){
                    viewPagerAdapter.addFragment(ChatsFragment.newInstance(onItemClick), "Messages");
                } else {
                    viewPagerAdapter.addFragment(ChatsFragment.newInstance(onItemClick), "Messages ("+unread+" new)");
                }
